...
| AIChannelRestrictionIntegrationTest.java | UT-AIC-015 | packages/ai/src/__tests__/integration/ai-channel-restriction.integration.test.ts |
...
| AIChatMentionListener reasoning/error cases | UT-AIC-017 | packages/ai/src/commands/__tests__/mention-listener.parity.test.ts |
...
| AgentConfigCacheInvalidationListener | UT-AG-027 | packages/ai/src/services/routing/__tests__/agent-config-cache-invalidation-listener.parity.test.ts |
...
| LangChain4jAIChatService AGENT_MAX_ITERATIONS | UT-AG-526 | packages/ai/src/services/__tests__/langchain-ai-chat-service.parity.test.ts |

## External deps (external-deps-adoption)

| PoC / UT | TS target |
|----------|-----------|
| POC-ED-001 | packages/ai/src/__tests__/integration/langgraph-checkpoint.poc.test.ts (postgres) |
| POC-ED-002 | packages/ai/src/__tests__/integration/langgraph-checkpoint.poc.test.ts (redis) |
| POC-ED-003 | packages/ai/src/__tests__/unit/zod-tool-schema.poc.test.ts |
| POC-ED-004 | packages/shop/src/__tests__/poc/robojs-mock.poc.test.ts |
| POC-ED-005 | packages/shop/src/__tests__/poc/supertest-callback.poc.test.ts |
