...
- T1.1 [ ] **更新 package.json** — @langchain/core 1.x、@langchain/openai 1.x、marked 18
  - Verify: `pnpm install`
...
- T2.1 [ ] **更新 ChatOpenAI 初始化** — 適配 1.x constructor/options
- T2.2 [ ] **更新 Agent / tool binding** — 適配 Runnable API
- T2.3 [ ] **修復測試 mock** — 適配新 response shape
...
- T3.1 [ ] **更新 marked 呼叫** — async/sync API
- T3.2 [ ] **更新 markdown 測試 oracle**
