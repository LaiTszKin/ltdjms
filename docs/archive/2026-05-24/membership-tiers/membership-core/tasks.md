...
- T1.1 [x] **撰寫 migration** — 見 design.md schema
...
- T2.1 [x] **MembershipTier enum + MembershipTierConfig**
  - Verify: unit test 斷言門檻/折扣/贈幣
- T2.2 [x] **MembershipTierEvaluator**
...
- T3.1 [x] **JdbcMembershipRepository**
  - Verify: integration test findOrCreate + save
- T3.2 [x] **MembershipModule 註冊**
  - Verify: `make build`
