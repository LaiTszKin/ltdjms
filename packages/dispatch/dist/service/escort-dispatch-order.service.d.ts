...
export declare class EscortDispatchOrderService {
    ...
    constructor(repository: EscortDispatchOrderRepo, orderNumberGenerator?: EscortDispatchOrderNumberGenerator | undefined, clock?: (() => number) | undefined, catalogRepository?: EscortOptionCatalogRepository | undefined, afterSalesStaffService?: DispatchAfterSalesStaffService | undefined);
    /** 建立待確認的新派單訂單。 */
    ...
    findByOrderNumber(orderNumber: string): Promise<Result<EscortDispatchOrder, DomainError>>;
