...
describe('MockDiscordContext', () => {
    ...
    it('validates positive ids', () => {
        expect(() => new MockDiscordContext(0, 456, 789, '<@456>')).toThrow('guildId must be positive');
        expect(() => new MockDiscordContext(123, 0, 789, '<@456>')).toThrow('userId must be positive');
        expect(() => new MockDiscordContext(123, 456, 0, '<@456>')).toThrow('channelId must be positive');
    });
