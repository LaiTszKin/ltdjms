...
export class DiceGame1ConfigHandler {
    ...
    commandName = 'dice-game-1-config';
    constructor(diceConfigRepository) {
    ...
    async execute(interaction, context) {
        ...
        try {
            ...
            await interaction.reply(`${DiceGameMessages.DICE_CONFIG_SUCCESS}\n${DiceGameMessages.DICE_CONFIG_1_DISPLAY
            ...
            await interaction.reply(DiceGameMessages.DICE_CONFIG_FAILED
...
export class DiceGame2ConfigHandler {
    diceConfigRepository;
    commandName = 'dice-game-2-config';
    constructor(diceConfigRepository) {
        this.diceConfigRepository = diceConfigRepository;
    }
    async execute(interaction, context) {
...
//# sourceMappingURL=dice-config-handlers.js.map