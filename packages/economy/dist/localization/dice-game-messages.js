...
export const DiceGameMessages = {
    ...
    DICE_CONFIG_2_DISPLAY: '代幣範圍：{min} ~ {max}\n順子倍率：{straightMul}\n基本倍率：{baseMul}\n三條低獎：{tripleLow}\n三條高獎：{tripleHigh}',
    // ============================================================
    // Common / Errors
    // ============================================================
...
//# sourceMappingURL=dice-game-messages.js.map