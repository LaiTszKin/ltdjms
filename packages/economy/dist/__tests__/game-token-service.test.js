...
describe('GameTokenService', () => {
    ...
    describe('getBalance', () => {
        it('should return cached balance when available', async () => {
            ...
            const service = new GameTokenService(mockAccountRepo, createMockEventPublisher(), mockCacheService, mockCacheKeyGenerator);
    ...
    describe('tryDeductTokens', () => {
        it('should deduct tokens successfully', async () => {
            ...
            const service = new GameTokenService(mockAccountRepo, eventPublisher, mockCacheService, mockCacheKeyGenerator);
        ...
        it('should reject zero token deduction', async () => {
            const service = new GameTokenService({}, createMockEventPublisher(), {}, mockCacheKeyGenerator);
        ...
        it('should propagate insufficient tokens error', async () => {
            ...
            const service = new GameTokenService(mockAccountRepo, createMockEventPublisher(), {}, mockCacheKeyGenerator);
    ...
    describe('hasEnoughTokens', () => {
        it('should return true when balance >= required', async () => {
            ...
            const service = new GameTokenService({}, createMockEventPublisher(), mockCacheService, mockCacheKeyGenerator);
...
//# sourceMappingURL=game-token-service.test.js.map