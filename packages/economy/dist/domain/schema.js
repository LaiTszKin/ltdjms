 ...
 */
export const memberCurrencyAccount = pgTable('member_currency_account', {
 ...
 */
export const currencyTransaction = pgTable('currency_transaction', {
 ...
 */
export const gameTokenAccount = pgTable('game_token_account', {
    guildId: bigint('guild_id', { mode: 'number' }).notNull(),
    userId: bigint('user_id', { mode: 'number' }).notNull(),
 ...
 */
export const gameTokenTransaction = pgTable('game_token_transaction', {
    id: bigserial('id', { mode: 'number' }),
    guildId: bigint('guild_id', { mode: 'number' }).notNull(),
    userId: bigint('user_id', { mode: 'number' }).notNull(),
    amount: bigint('amount', { mode: 'number' }).notNull(),
