...
export class CurrencyTransactionService {
     ...
     * Page is 1-based.
     */
    async getTransactionPage(guildId, userId, page = 1, pageSize = CurrencyTransactionService.DEFAULT_PAGE_SIZE) {
        if (page < 1)
            page = 1;
        if (pageSize < 1)
            pageSize = CurrencyTransactionService.DEFAULT_PAGE_SIZE;
...
//# sourceMappingURL=currency-tx-service.js.map