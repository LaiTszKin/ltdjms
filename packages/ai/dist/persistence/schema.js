import { pgTable, bigint, varchar, boolean, timestamp, bigserial, primaryKey, index, uniqueIndex, } from 'drizzle-orm/pg-core';
/**
 ...
 * logical entity name.
 */
export const aiAllowedChannel = pgTable('ai_channel_restriction', {
 ...
 */
export const aiAllowedCategory = pgTable('ai_category_restriction', {
    guildId: bigint('guild_id', { mode: 'number' }).notNull(),
 ...
 */
export const aiAgentChannelConfig = pgTable('ai_agent_channel_config', {
