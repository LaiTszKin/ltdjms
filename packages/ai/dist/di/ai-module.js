...
import { DefaultPromptLoader } from '../prompts/prompt-loader.js';
// Routing Services
...
export function initializeAIModule() {
    const envConfig = container.resolve(TOKENS.EnvironmentConfig);
    ...
    const runtimeGateway = container.resolve(TOKENS.DiscordRuntimeGateway);
    // ===== Config =====
    ...
    container.registerInstance(AI_TOKENS.AIChatService, aiChatService);
    // ===== Tools =====
    ...
    container.registerInstance(AI_TOKENS.CreateChannelTool, new CreateChannelTool(authGuard, permissionParser));
    container.registerInstance(AI_TOKENS.CreateCategoryTool, new CreateCategoryTool(authGuard, permissionParser));
    ...
    container.registerInstance(AI_TOKENS.GetChannelPermissionsTool, new GetChannelPermissionsTool(authGuard));
    container.registerInstance(AI_TOKENS.GetCategoryPermissionsTool, new GetCategoryPermissionsTool(authGuard));
    container.registerInstance(AI_TOKENS.GetRolePermissionsTool, new GetRolePermissionsTool(authGuard));
    container.registerInstance(AI_TOKENS.ModifyChannelPermissionsTool, new ModifyChannelPermissionsTool(authGuard, permissionParser));
    container.registerInstance(AI_TOKENS.ModifyCategoryPermissionsTool, new ModifyCategoryPermissionsTool(authGuard, permissionParser));
    container.registerInstance(AI_TOKENS.ModifyRolePermissionsTool, new ModifyRolePermissionsTool(authGuard));
    ...
    container.registerInstance(AI_TOKENS.DeleteDiscordResourceTool, new DeleteDiscordResourceTool(authGuard));
    // ===== Memory =====
