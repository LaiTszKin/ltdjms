...
describe('DiscordMarkdownPaginator', () => {
    ...
    const createPaginator = (maxLength = 1900) => new DiscordMarkdownPaginator(maxLength);
    ...
    it('should handle code fence boundaries across pages', () => {
        ...
        const combinedBackticks = result.reduce((sum, page) => sum + (page.match(/```/g) || []).length, 0);
    ...
    it('should handle large content efficiently', () => {
        ...
        const sections = Array.from({ length: sectionCount }, (_, i) => `## Section ${i + 1}\n\n` + 'Content '.repeat(50));
...
//# sourceMappingURL=markdown-paginator.test.js.map