...
import { InMemoryAIChannelRestrictionRepository, DefaultAIChannelRestrictionService, } from '../../services/routing/channel-restriction-service.js';
import { InMemoryAIAgentChannelConfigRepository, DefaultAIAgentChannelConfigService, } from '../../services/routing/agent-config-service.js';
...
function createMockThreadChannel(parentId) {
    return {
        id: 'thread-1',
        parentId,
        isThread: () => true,
...
//# sourceMappingURL=routing-decision.test.js.map