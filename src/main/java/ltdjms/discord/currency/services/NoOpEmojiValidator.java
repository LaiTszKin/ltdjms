...
/**
 * A no-op EmojiValidator that always returns true for valid-looking custom emoji patterns. Used for
 * integration tests where JDA is not available.
 */
public class NoOpEmojiValidator implements EmojiValidator {

  /**
   * Pattern to validate Discord custom emoji format. Matches: {@code <:name:id>} or {@code
