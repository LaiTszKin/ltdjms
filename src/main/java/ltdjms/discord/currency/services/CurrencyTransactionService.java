...
/**
 * Service for querying currency transaction history.
...
public class CurrencyTransactionService {
    ...
    public TransactionPage getTransactionPage(long guildId, long userId, int page, int pageSize) {
        ...
        List<CurrencyTransaction> transactions = transactionRepository.findByGuildIdAndUserId(
        ...
        LOG.debug("Retrieved currency transaction page: guildId={}, userId={}, page={}/{}, count={}",
    ...
    public CurrencyTransaction recordTransaction(
        ...
        CurrencyTransaction transaction = CurrencyTransaction.create(
                guildId, userId, amount, balanceAfter, source, description);
        CurrencyTransaction saved = transactionRepository.save(transaction);
        LOG.info("Recorded currency transaction: guildId={}, userId={}, amount={}, source={}",
