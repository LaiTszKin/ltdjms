...
/**
 * JDA-based implementation of EmojiValidator.
 * Uses JDA's Emoji.fromFormatted() to parse and validate custom emoji markup.
 */
public class JdaEmojiValidator implements EmojiValidator {
    ...
    /**
     * Pattern to match Discord custom emoji format.
