...
/**
 * Factory for creating the main Dagger {@link AppComponent}. Centralizes the wiring logic so both
 * production code and tests can build the component in a consistent way.
 */
