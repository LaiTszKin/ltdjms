...
/**
 * A Result type that represents either a success value or an error. Inspired by Rust's Result<T, E>
...
public sealed interface Result<T, E> permits Result.Ok, Result.Err {
  ...
  /**
   * Creates a success result with a Unit value for void operations. Use this when the success case
   * doesn't need to carry a meaningful value.
   */
  ...
  /**
   * Maps the success value using the given function. If this is an error, returns the error
   * unchanged.
   */
  <U> Result<U, E> map(Function<? super T, ? extends U> mapper);

  /**
   * Maps the success value using a function that returns a Result. If this is an error, returns the
   * error unchanged.
   */
  <U> Result<U, E> flatMap(Function<? super T, ? extends Result<U, E>> mapper);

  /**
   * Maps the error using the given function. If this is a success, returns the success value
   * unchanged.
   */
