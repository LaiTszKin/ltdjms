...
/** Publishes domain events to registered listeners. Events are dispatched synchronously. */
public class DomainEventPublisher {
  ...
  /**
   * Publishes an event to all registered listeners. Exceptions thrown by listeners are caught and
   * logged, preventing them from propagating to the publisher.
   *
