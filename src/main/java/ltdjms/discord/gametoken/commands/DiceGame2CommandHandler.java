...
/**
 * Handler for the /dice-game-2 slash command.
 * Allows players to play the dice-game-2 mini-game by spending game tokens.
 *
 * <p>Players must explicitly specify how many tokens to spend; the number of dice
 * rolled equals the number of tokens spent multiplied by 3 (1 token = 3 dice).</p>
 *
...
public class DiceGame2CommandHandler implements SlashCommandListener.CommandHandler {
    ...
    public void handle(SlashCommandInteractionEvent event) {
        ...
        LOG.debug("Processing /dice-game-2 for guildId={}, userId={}, locale={}", guildId, userId, locale);
