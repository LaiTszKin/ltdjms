...
/**
 * Handler for the /dice-game-1 slash command. Allows players to play the dice mini-game by spending
 * game tokens.
 *
 * <p>Players must explicitly specify how many tokens to spend; the number of dice rolled equals the
 * number of tokens spent (1 token = 1 dice).
 *
...
public class DiceGame1CommandHandler implements SlashCommandListener.CommandHandler {
  ...
  public void handle(SlashCommandInteractionEvent event) {
    ...
    LOG.debug(
        "Processing /dice-game-1 for guildId={}, userId={}, locale={}", guildId, userId, locale);
    ...
    String message =
        DiceGameMessages.formatDiceGame1Result(
