...
/**
 * Service for querying game token transaction history. Provides methods to retrieve paginated
...
public class GameTokenTransactionService {
  ...
  public GameTokenTransaction recordTransaction(
      ...
      String description) {
    GameTokenTransaction transaction =
        GameTokenTransaction.create(guildId, userId, amount, balanceAfter, source, description);
    GameTokenTransaction saved = transactionRepository.save(transaction);
    LOG.info(
        "Recorded transaction: guildId={}, userId={}, amount={}, source={}",
        guildId,
        userId,
        amount,
        source);
