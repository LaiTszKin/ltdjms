...
public class ProductRedemptionTransactionService {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ProductRedemptionTransactionService.class);
    ...
    public ProductRedemptionTransactionService(ProductRedemptionTransactionRepository transactionRepository) {
    ...
    public ProductRedemptionTransaction recordTransaction(
        ...
        if (product.hasReward()) {
            ...
            rewardType = switch (product.rewardType()) {
        ...
        LOG.info("Recorded product redemption transaction: guildId={}, userId={}, product={}, quantity={}",
                guildId, userId, product.name(), redemptionCode.quantity());
        return saved;
    }
    ...
    public TransactionPage getTransactionPage(long guildId, long userId, int page, int pageSize) {
        ...
        List<ProductRedemptionTransaction> transactions = transactionRepository.findByGuildIdAndUserId(
        ...
        LOG.debug("Retrieved product redemption transaction page: guildId={}, userId={}, page={}/{}, count={}",
