 ...
 *
 * <p>此介面提供流式 API 來建構 Discord Embed 訊息， 並自動處理 Discord API 的長度限制。
 *
 * <h2>Discord API 長度限制：</h2>
 *
 * <ul>
 *   <li>Title: 256 字元
 *   <li>Description: 4096 字元
 *   <li>Field Name: 256 字元
 *   <li>Field Value: 1024 字元
 *   <li>Fields: 25 個
 *   <li>Footer: 2048 字元
 * </ul>
 *
...
public interface DiscordEmbedBuilder {
   ...
   * 新增一個欄位
   *
   * <p>欄位名稱超過 256 字元或值超過 1024 字元時將自動截斷。 如果已達 25 個欄位上限，將忽略此呼叫。
   *
