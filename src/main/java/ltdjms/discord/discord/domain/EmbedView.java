 ...
 *
 * <p>長度限制驗證由 {@link DiscordEmbedBuilder#buildPaginated(EmbedView)} 負責， 以支援自動分頁功能。
 *
 * @param title 標題
...
public record EmbedView(
    String title, String description, Color color, List<FieldView> fields, String footer) {
  /**
   * 欄位視圖
   *
   * @param name 名稱
   ...
   * @param inline 是否內聯顯示
   */
  public record FieldView(String name, String value, boolean inline) {
