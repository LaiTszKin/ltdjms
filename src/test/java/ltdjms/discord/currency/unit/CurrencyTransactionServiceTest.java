...
class CurrencyTransactionServiceTest {
    ...
    class RecordTransaction {
        ...
        void shouldSaveTransaction() {
            ...
            CurrencyTransaction saved = new CurrencyTransaction(
                    ...
                    CurrencyTransaction.Source.ADMIN_ADJUSTMENT, "Test", Instant.now());
            when(transactionRepository.save(any(CurrencyTransaction.class))).thenReturn(saved);

            // When
            CurrencyTransaction result = service.recordTransaction(
                    TEST_GUILD_ID, TEST_USER_ID, 50, 150,
                    CurrencyTransaction.Source.ADMIN_ADJUSTMENT, "Test");
    ...
    private CurrencyTransaction createTransaction(long id, long amount, long balanceAfter,
