 ...
 * Verifies that buildAllCommandDefinitions produces correct command data
 * and that the command sync logic behaves correctly.
 *
 * <p>Note: Legacy commands (/balance, /adjust-balance, /game-token-adjust,
 * /dice-game-1-config, /dice-game-2-config) have been removed.</p>
 */
class SlashCommandListenerTest {
    ...
    void setUp() {
        ...
        listener = new SlashCommandListener(null, null, null, null, null);
    }
    ...
    class BuildAllCommandDefinitionsTests {
        ...
        @Test
        @DisplayName("should return exactly 5 command definitions")
        ...
        void shouldNotIncludeLegacyCommands() {
            ...
            assertThat(commandNames)
                    .doesNotContain("balance", "adjust-balance", "game-token-adjust",
                            "dice-game-1-config", "dice-game-2-config");
        }
        ...
        void shouldReturnConsistentDefinitions() {
            ...
            Set<String> firstNames = firstCall.stream()
                    .map(SlashCommandData::getName)
                    .collect(Collectors.toSet());
            Set<String> secondNames = secondCall.stream()
                    .map(SlashCommandData::getName)
                    .collect(Collectors.toSet());
        ...
        void shouldNotIncludeSyncCommandsCommand() {
            ...
            assertThat(commandNames)
                    .doesNotContain("sync-commands", "sync", "register-commands");
        }
    }
    ...
    class CommandConstantsTests {
        ...
        @Test
        @DisplayName("should have exactly 5 command constants matching definitions")
        void shouldHaveMatchingCommandCount() {
            ...
            assertThat(commandNames).contains(
    ...
    class RegisterCommandsTests {
        ...
        void shouldClearGlobalCommandsBeforeSyncingGuildCommands() {
            ...
            CommandListUpdateAction globalUpdateAction = mock(CommandListUpdateAction.class, RETURNS_SELF);
            CommandListUpdateAction guild1UpdateAction = mock(CommandListUpdateAction.class, RETURNS_SELF);
            CommandListUpdateAction guild2UpdateAction = mock(CommandListUpdateAction.class, RETURNS_SELF);
