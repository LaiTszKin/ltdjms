...
class DiceGameMessagesTest {
  ...
  class DiceGame1ZhTwMessages {
    ...
    void shouldFormatResultMessageInZhTw() {
      ...
      // When
      String message =
          DiceGameMessages.formatDiceGame1Result(result, "💰", "金幣", DiscordLocale.CHINESE_TAIWAN);
    ...
    void shouldFormatInsufficientTokensMessageInZhTw() {
      // When
      String message =
          DiceGameMessages.formatInsufficientTokens(10, 5, DiscordLocale.CHINESE_TAIWAN);
  ...
  class DiceGame1EnglishMessages {
    ...
    void shouldFormatResultMessageInEnglish() {
      ...
      // When
      String message =
          DiceGameMessages.formatDiceGame1Result(result, "💰", "Gold", DiscordLocale.ENGLISH_US);
    ...
    void shouldFormatInsufficientTokensMessageInEnglish() {
      // When
      String message = DiceGameMessages.formatInsufficientTokens(10, 5, DiscordLocale.ENGLISH_US);
  ...
  class DiceGame2ZhTwMessages {
    ...
    void shouldFormatResultMessageInZhTwWithStraightsAndTriples() {
      ...
      // When
      String message =
          DiceGameMessages.formatDiceGame2Result(result, "💰", "金幣", DiscordLocale.CHINESE_TAIWAN);
  ...
  class DiceGame2EnglishMessages {
    ...
    void shouldFormatResultMessageInEnglish() {
      ...
      // When
      String message =
          DiceGameMessages.formatDiceGame2Result(result, "💰", "Gold", DiscordLocale.ENGLISH_US);
  ...
  class TokenRangeErrorMessages {
    ...
    void shouldFormatTokenRangeErrorMessageInZhTw() {
      // When
      String message =
          DiceGameMessages.formatTokenRangeError(100L, 5L, 50L, DiscordLocale.CHINESE_TAIWAN);
    ...
    void shouldFormatTokenRangeErrorMessageInEnglish() {
      // When
      String message =
          DiceGameMessages.formatTokenRangeError(100L, 5L, 50L, DiscordLocale.ENGLISH_US);
    ...
    void shouldFormatBelowMinimumErrorInZhTw() {
      // When
      String message =
          DiceGameMessages.formatTokenRangeError(2L, 5L, 50L, DiscordLocale.CHINESE_TAIWAN);
    ...
    void shouldFormatAboveMaximumErrorInEnglish() {
      // When
      String message =
          DiceGameMessages.formatTokenRangeError(60L, 5L, 50L, DiscordLocale.ENGLISH_US);
