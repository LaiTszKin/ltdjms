...
/**
 * Unit tests for DiceGame2CommandHandler response formatting.
    ...
    class DiceGame2ResultFormatting {
        ...
        void shouldIncludeTotalRewardAndNewBalance() {
            ...
            DiceGame2Result result = new DiceGame2Result(
                    ...
                    300_000L, 10_000_000L, 10_300_000L,
                    List.of(),
                    List.of(),
                    0L,
                    300_000L,
