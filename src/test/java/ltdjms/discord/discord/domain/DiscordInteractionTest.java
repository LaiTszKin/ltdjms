...
class DiscordInteractionTest {
  ...
  void getGuildId_shouldReturnCorrectGuildId() {
    ...
    DiscordInteraction interaction =
        new TestDiscordInteraction(expectedGuildId, 987654321L, false, mockHook);
  ...
  void getUserId_shouldReturnCorrectUserId() {
    ...
    InteractionHook mockHook = mock(InteractionHook.class);
    DiscordInteraction interaction =
        new TestDiscordInteraction(123456789L, expectedUserId, false, mockHook);
  ...
  void isEphemeral_shouldReturnEphemeralStatus() {
    // Given
    InteractionHook mockHook = mock(InteractionHook.class);
    DiscordInteraction ephemeralInteraction =
        new TestDiscordInteraction(123456789L, 987654321L, true, mockHook);
    DiscordInteraction publicInteraction =
        new TestDiscordInteraction(123456789L, 987654321L, false, mockHook);
  ...
  void reply_shouldStoreMessageAndMarkAsAcknowledged() {
    ...
    String message = "測試訊息";
    InteractionHook mockHook = mock(InteractionHook.class);
    TestDiscordInteraction interaction =
        new TestDiscordInteraction(123456789L, 987654321L, false, mockHook);
