...
class ModalInteractionAdapterTest {
  ...
  @Mock private ModalInteractionEvent event;

  @Mock private ReplyCallbackAction replyAction;

  @Mock
  private net.dv8tion.jda.api.requests.restaction.WebhookMessageEditAction<
          net.dv8tion.jda.api.entities.Message>
      webhookMessageEditAction;

  @Mock private InteractionHook hook;

  @Mock private ModalMapping modalMapping;
