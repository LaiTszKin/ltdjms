...
class ProductRedemptionTransactionTest {
  ...
  class TransactionCreationTests {
    ...
    void shouldCreateTransactionWithCurrencyReward() {
      ...
      assertThat(transaction.rewardType())
          .isEqualTo(ProductRedemptionTransaction.RewardType.CURRENCY);
  ...
  class RewardTypeTests {
    ...
    void currencyShouldHaveCorrectDisplayName() {
      assertThat(ProductRedemptionTransaction.RewardType.CURRENCY.getDisplayName()).isEqualTo("貨幣");
    }

    @Test
    @DisplayName("TOKEN should have correct display name")
    void tokenShouldHaveCorrectDisplayName() {
      assertThat(ProductRedemptionTransaction.RewardType.TOKEN.getDisplayName()).isEqualTo("代幣");
    }
  }
}
