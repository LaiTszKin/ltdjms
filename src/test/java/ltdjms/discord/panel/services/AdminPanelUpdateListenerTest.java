...
class AdminPanelUpdateListenerTest {
  ...
  void accept_shouldHandleDiceGame2ConfigChangedEvent() {
    // Given
    DiceGameConfigChangedEvent event =
        new DiceGameConfigChangedEvent(789L, DiceGameConfigChangedEvent.GameType.DICE_GAME_2);
  ...
  void accept_shouldHandleProductCreatedEvent() {
    ...
    ProductChangedEvent event =
        new ProductChangedEvent(100L, 1L, ProductChangedEvent.OperationType.CREATED);
  ...
  void accept_shouldHandleProductUpdatedEvent() {
    // Given
    ProductChangedEvent event =
        new ProductChangedEvent(100L, 2L, ProductChangedEvent.OperationType.UPDATED);
  ...
  void accept_shouldHandleProductDeletedEvent() {
    // Given
    ProductChangedEvent event =
        new ProductChangedEvent(100L, 3L, ProductChangedEvent.OperationType.DELETED);
