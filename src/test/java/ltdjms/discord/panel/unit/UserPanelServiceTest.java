...
class UserPanelServiceTest {
  ...
  @BeforeEach
  void setUp() {
    memberInfoFacade = mock(MemberInfoFacade.class);
    userPanelService = new UserPanelService(memberInfoFacade);
  }
  ...
  class GetUserPanelView {
    ...
    void shouldReturnViewWithZeroGameTokens() {
      ...
      Result<UserPanelView, DomainError> expectedResult =
          Result.ok(
              new UserPanelView(TEST_GUILD_ID, TEST_USER_ID, 500L, "Diamonds", "💎", 0L, null));
      when(memberInfoFacade.getUserPanelView(TEST_GUILD_ID, TEST_USER_ID))
          .thenReturn(expectedResult);
  ...
  class UserPanelViewFormatting {
    ...
    void shouldFormatEmbedTitleCorrectly() {
      // Given
      UserPanelView view =
          new UserPanelView(TEST_GUILD_ID, TEST_USER_ID, 1000L, "Gold", "💰", 50L, null);
    ...
    void shouldFormatZeroBalancesCorrectly() {
      // Given
      UserPanelView view =
          new UserPanelView(TEST_GUILD_ID, TEST_USER_ID, 0L, "Coins", "🪙", 0L, null);
    ...
    void shouldIncludeCurrencyNameInFieldName() {
      ...
      UserPanelView view =
          new UserPanelView(TEST_GUILD_ID, TEST_USER_ID, 1000L, "星幣", "✨", 50L, null);
  ...
  class GetTokenTransactionPage {
    ...
    void shouldReturnTransactionPage() {
      ...
      when(memberInfoFacade.getTokenTransactionPage(TEST_GUILD_ID, TEST_USER_ID, 1))
  ...
  class GetCurrencyTransactionPage {
    ...
    void shouldReturnCurrencyTransactionPage() {
      ...
      when(memberInfoFacade.getCurrencyTransactionPage(TEST_GUILD_ID, TEST_USER_ID, 1))
          .thenReturn(expectedPage);
