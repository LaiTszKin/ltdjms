...
class AdminPanelServiceTest {
    ...
    class GetMemberBalance {
        ...
        void shouldReturnBalanceWhenFound() {
            ...
            // When
            Result<Long, DomainError> result = adminPanelService.getMemberBalance(TEST_GUILD_ID, TEST_USER_ID);
    ...
    class GameConfiguration {
        ...
        void shouldUpdateDiceGame2TokenRange() {
            ...
            Result<DiceGame2Config, DomainError> result =
                    adminPanelService.updateDiceGame2Config(TEST_GUILD_ID, 10L, 40L,
                            null, null, null, null);
        ...
        void shouldUpdateDiceGame2Multipliers() {
            ...
            // When
            Result<DiceGame2Config, DomainError> result =
                    adminPanelService.updateDiceGame2Config(TEST_GUILD_ID, null, null,
                            200_000L, 40_000L, null, null);
        ...
        void shouldUpdateDiceGame2Bonuses() {
            ...
            Result<DiceGame2Config, DomainError> result =
                    adminPanelService.updateDiceGame2Config(TEST_GUILD_ID, null, null,
                            null, null, 3_000_000L, 5_000_000L);
    ...
    class AdminPanelButtonHandlerConstants {
        ...
        void shouldDefineAllButtonIds() {
            ...
            assertThat(AdminPanelButtonHandler.BUTTON_OPEN_BALANCE_MODAL).isEqualTo("admin_open_balance_modal");
            assertThat(AdminPanelButtonHandler.BUTTON_OPEN_TOKEN_MODAL).isEqualTo("admin_open_token_modal");
        }

        @Test
        @DisplayName("should define all modal IDs")
        void shouldDefineAllModalIds() {
            assertThat(AdminPanelButtonHandler.MODAL_BALANCE_ADJUST).isEqualTo("admin_modal_balance_adjust");
            ...
            assertThat(AdminPanelButtonHandler.MODAL_GAME_2_MULTIPLIERS).isEqualTo("admin_modal_game2_multipliers");
            assertThat(AdminPanelButtonHandler.MODAL_GAME_2_BONUSES).isEqualTo("admin_modal_game2_bonuses");
        }
        ...
        void shouldDefineAllSelectMenuIds() {
            ...
            assertThat(AdminPanelButtonHandler.SELECT_BALANCE_USER).isEqualTo("admin_select_balance_user");
            assertThat(AdminPanelButtonHandler.SELECT_BALANCE_MODE).isEqualTo("admin_select_balance_mode");
            ...
            assertThat(AdminPanelButtonHandler.SELECT_GAME_SETTING).isEqualTo("admin_select_game_setting");
        }
    }
}
